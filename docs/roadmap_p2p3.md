...
- 候选池查证闭环（2026-08 CEO 查证 + Solo web 复核）：① GLM-4.5-Air=106B 稀疏 MoE，服务器级，毙；② Gemma 3 4B 横向对比远不如 qwen3.5-4b，毙；③ Hunyuan-7B JSON/生态弱，毙；④ DeepSeek 推理型、Llama/Gemma 英文系与任务不适配；⑤ GLM 开源稠密端侧仅 GLM-4-9B-Chat（9B，4-bit≈5.5GB，卡 8GB 空闲线上、无余量），更小的 GLM-4-Flash/4.5-Flash 为 API-only 不开源——故 GLM 系在 8GB 卡上亦无合格对手。结论：**8GB 部署约束下 qwen3.5-4b 当前无对手，横评取消，换脑决策暂闭环**；未来新模型按第 12 节换脑门槛随时重启测评。
