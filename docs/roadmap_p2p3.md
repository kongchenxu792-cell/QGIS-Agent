...
- 候选池查证（2026-08，Solo 多轮核实 + P1.7 实测定案）：**qwen3.5-4b 维持现役，换脑候选池正式闭环**。Gemma-4-E4B-it = 8B 稠密（vllm 确认）；ollama Q4=9.6GB 超线，Q3=3.87GB 可进 8GB。P1.7 实测：qwen3.5-4b@Q4 完胜 E4B-it@Q3（识别率 86.7% vs 76.0%、三语 4/4 vs 2/4、nojson 0 vs 6、速度 54 vs 49、显存 3GB vs 5.4GB）→ 换脑门槛四项 E4B 全败，根因=Q3 对 8B 语义/多语 JSON 损耗 > 多 4B 参数收益。其余候选（GLM Air=106B MoE/稠密9B 超线、Qwen3.6 无 4B 稠密、Hunyuan/DeepSeek/Llama 不适配）均淘汰。教训：① 标签名≠参数量 ② 量化档位可变，Q4 超线≠Q3 超 ③ 能跑≠跑得好（手机部署≠质量达标）④ 换脑决策靠 25×3 实测不靠猜。
